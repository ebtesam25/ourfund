        ...
        <View style={styles.container}>
            <View style={{ marginTop: '15%',}}>
              <View style={{flexDirection:'row', display:'flex', marginHorizontal:'10%'}}>
                  ...
                  <Text style={{fontFamily:'G', fontSize:30, color:'#28324B', textAlign:'right'}}>Make Deposit</Text>
              </View>
              <View style={{position:'relative', marginLeft:'10%', marginTop:'1%'}}>
                ...
                <Text style={{fontFamily:'G', fontSize:20, color:'#28324B', marginTop:'10%'}}>Amount</Text>
                <TextInput style={{fontFamily:'K', color:'#28324B'}} placeholder='$'>
                </TextInput>
                <Text style={{fontFamily:'G', fontSize:15, color:'#28324B', marginTop:'10%'}}>Remarks</Text>
            ...
            <View style={{backgroundColor:'#FFBF00', marginTop:'5%', width:'60%', alignSelf:'center', paddingVertical:'5%', borderRadius:10, marginLeft:'-15%'}}>
                <TouchableOpacity onPress={()=>navigation.navigate('DepositRes')}><Text style={{textAlign:'center', color:'#28324B', fontFamily:'G', fontSize:18}}>Make a Deposit</Text></TouchableOpacity>
              </View>
